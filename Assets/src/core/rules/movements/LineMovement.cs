...
{
    public class LineMovement : FigureMovementType
    {
        public LineMovement(int range = StaticParameters.BOARD_SIZE) : base(range)
        {
        }
        ...
        public override bool PossibleToMove(CellPosition from, CellPosition to, Board board)
        {
            ...
            // even moved
            if (signCol == 0 && signRow == 0 || signCol != 0 && signRow != 0) return false;
